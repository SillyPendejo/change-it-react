...
function Footer() {
    ...
    const linkList = linkNames.map( (name) =>
        <li className="footer__link" key={name}><a className="footer__link_real" href="#">{name}</a></li>)

    return (
    <footer className="footer block_pink">
        <div className="footer__newsletter">
            <label htmlFor="newsletter" className="footer__newsletter-label">Newsletter</label>
